...
impl MigrationTrait for Migration {
                ...
                Table::create()
                    ...
                    .col(
                        ColumnDef::new_with_type(
                            Alias::new("type_plat"),
                            ColumnType::Enum {
                                name: Alias::new("TypePlat").into_iden(),
                                variants: vec![
                                    Alias::new("entree").into_iden(),
                                    Alias::new("plat").into_iden(),
                                    Alias::new("dessert").into_iden(),
                                ],
                            },
                        )
                        .not_null(),
                    ...
                    .col(
                        ColumnDef::new(Alias::new("est_viande"))
                            .boolean()
                            .not_null(),
                    )
                    .to_owned(),
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(Alias::new("plats")).to_owned())
            .await?;
        manager
            .get_connection()
            .execute_unprepared("DROP TYPE IF EXISTS TypePlat")
            .await?;
