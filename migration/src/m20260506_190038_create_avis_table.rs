...
impl MigrationTrait for Migration {
                ...
                Table::create()
                    ...
                    .col(
                        ColumnDef::new_with_type(
                            Alias::new("statut"),
                            ColumnType::Enum {
                                name: Alias::new("StatutAvis").into_iden(),
                                variants: vec![
                                    Alias::new("en_attente").into_iden(),
                                    Alias::new("valide").into_iden(),
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(Alias::new("avis")).to_owned())
            .await?;
        manager
            .get_connection()
            .execute_unprepared("DROP TYPE IF EXISTS StatutAvis")
            .await?;
