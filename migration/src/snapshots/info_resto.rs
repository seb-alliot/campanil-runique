        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Alias::new("prix_livraison")).decimal().null().default(0.59))
                    .col(ColumnDef::new(Alias::new("prix_livraison_minimal")).decimal().null().default(5.00))
                    .col(ColumnDef::new(Alias::new("penalite_materiel")).decimal().null().default(600.00))
