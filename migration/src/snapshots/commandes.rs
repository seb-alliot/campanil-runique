        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new_with_type(Alias::new("statut"), ColumnType::Enum { name: Alias::new("StatutCommande").into_iden(), variants: vec![Alias::new("en_attente").into_iden(), Alias::new("accepte").into_iden(), Alias::new("en_preparation").into_iden(), Alias::new("pret").into_iden(), Alias::new("en_cours_livraison").into_iden(), Alias::new("livre").into_iden(), Alias::new("attente_retour_materiel").into_iden(), Alias::new("termine").into_iden(), Alias::new("annule").into_iden()] }).not_null())
