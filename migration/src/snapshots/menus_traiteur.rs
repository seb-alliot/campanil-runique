        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new_with_type(Alias::new("theme"), ColumnType::Enum { name: Alias::new("ThemeMenu").into_iden(), variants: vec![Alias::new("mariage").into_iden(), Alias::new("bapteme").into_iden(), Alias::new("anniversaire").into_iden(), Alias::new("autre").into_iden()] }).not_null().default("autre"))
